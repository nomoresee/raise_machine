 ...
 */
#define LOWER_HOPPER_GATE_HW_READY             0U
#define LOWER_HOPPER_GATE_SIMULATION_ENABLE     1U

/* 待实车标定的占位参数。 */
#define LOWER_HOPPER_GATE_CLOSE_ANGLE_DEG        0.0f
#define LOWER_HOPPER_GATE_OPEN_ANGLE_DEG        90.0f
