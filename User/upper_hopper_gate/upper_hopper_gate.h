#ifndef __UPPER_HOPPER_GATE_H__
#define __UPPER_HOPPER_GATE_H__
...
/* 待实车标定的占位参数。 */
#define UPPER_HOPPER_GATE_CLOSE_ANGLE_DEG      105.0f
#define UPPER_HOPPER_GATE_OPEN_ANGLE_DEG        0.0f
#define UPPER_HOPPER_GATE_SPEED_DEG_PER_SEC    180.0f
#define UPPER_HOPPER_GATE_SETTLE_MARGIN_MS     120U
#define UPPER_HOPPER_GATE_ANGLE_TOL_DEG          1.0f
